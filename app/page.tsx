...
export default function Home() {
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-gradient-to-br from-slate-50 to-slate-100 dark:from-slate-900 dark:to-slate-800 p-4">
      {/* GitHub 链接 */}
      <a
        href="https://github.com/BYJRK/DriftCipher"
        target="_blank"
        rel="noopener noreferrer"
        className="fixed top-4 right-4 p-2 rounded-lg bg-white dark:bg-slate-800 shadow-lg hover:shadow-xl transition-all border border-slate-200 dark:border-slate-700"
        title="查看源代码"
      >
